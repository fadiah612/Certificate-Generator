            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('events.create') }}" class="btn btn-sm btn-neutral">{{ __('Add Event') }}</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                @foreach ($events as $event)
                                    <tr>
                                        ...
                                        <td class="align-middle">{{ $event->participant }}
                                            <a href="{{ route('participants.index', $event) }}"
                                                ...
                                                data-toggle="tooltip" data-placement="top" title="Lihat"><span
                                                    class="btn-inner--icon"><i class="fas fa-light fa-download"></i></span></a>
                                        </td>
